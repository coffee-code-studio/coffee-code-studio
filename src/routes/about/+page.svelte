...
<section class="bg-white dark:bg-gray-900 mt-20 mb-20">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div class="max-w-3xl">
        <h1 class="text-3xl font-bold sm:text-5xl dark:text-white">
      ...
      <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        ...
        <div class="lg:py-16">
          <article class="space-y-4 text-gray-600 dark:text-white">
            <h2 class="text-lg">
              Welcome to Coffee Code Studio, your premier destination for exceptional web development services. 
...
<section class="bg-white dark:bg-gray-900 mt-40 mb-40">
  <div class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
    <header>
      <h2 class="text-xl font-bold dark:text-white text-gray-600 sm:text-4xl">
        Technologies We Use
      </h2>
    </header>
    ...
    <ul class="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
      <li>
        <a href="https://kit.svelte.dev/" class="block">
          <img
            alt="Art"
            src={svelteLogo}
      ...
      <li>
        <a href="https://deno.land/" class="block">
          <img
            alt="Art"
            src={denoLogo}
            class="h-64 w-full object-cover sm:h-80 lg:h-96"
      ...
      <li>
        <a href="https://www.rust-lang.org/" class="block">
          <img
            alt="Art"
            src={rustLogo}
            class="h-64 w-full object-cover sm:h-80 lg:h-96"
      ...
      <li>
        <a href="https://webassembly.org/" class="block">
          <img
            alt="Art"
            src={wasmLogo}
            class="h-64 w-full object-cover sm:h-80 lg:h-96"
...
<section class="bg-white dark:bg-gray-900 mb-40 mt-40">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 class="mb-4 text-5xl  font-semibold text-center text-gray-900 dark:text-white">Collaborations</h2>
      <a href="https://schoodic.io/" class="block">
        <img
          alt="Art"
          src={schoodicLogo}
...
<!---
<section class="bg-white dark:bg-gray-900 mt-40 mb-40">
  <div class="h-[32rem] bg-gray-100 dark:bg-gray-900">
      <div class="container px-6 py-10 mx-auto">
          <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">Meet Our Team</h1>

          <h2 class="max-w-2xl mx-auto mt-6 text-center text-gray-500 dark:text-gray-300">
  ...
  <div class="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96">
      <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
            ...
            <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Lead Designer</p>
          ...
          <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
              ...
              <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Developer</p>
